...
#By Root Lock
echo -e "
__   __  _______  _______  ___   _  _______  ______
|  | |  ||   _   ||       ||   | | ||       ||    _ |
|  |_|  ||  |_|  ||       ||   |_| ||    ___||   | ||
|       ||       ||       ||      _||   |___ |   |_||_
|       ||       ||      _||     |_ |    ___||    __  |
|   _   ||   _   ||     |_ |    _  ||   |___ |   |  | |
|__| |__||__| |__||_______||___| |_||_______||___|  |_|
__   __  _______  ___   ___      ___   _______  __   __
|  | |  ||       ||   | |   |    |   | |       ||  | |  |
|  | |  ||_     _||   | |   |    |   | |_     _||  |_|  |
|  |_|  |  |   |  |   | |   |    |   |   |   |  |       |
|       |  |   |  |   | |   |___ |   |   |   |  |_     _|
|       |  |   |  |   | |       ||   |   |   |    |   |
|_______|  |___|  |___| |_______||___|   |___|    |___|
                   ..::BY ROOT LOCK::..
